...
#define XY_MTR_STPS 200.234     		// Enter number of steps per one revolution of the X and Y motors. See motor datasheet, 1.8degree = 200 steps, 0.9degree = 400 steps
#define Z_MTR_STPS 201       		// Enter number of steps per one revolution of the Z motor(s).
